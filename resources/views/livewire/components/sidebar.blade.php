    ...
    <div class="d-flex align-items-center">
      ...
      <a class="navbar-brand" href="/">
        <div class="d-flex align-items-center py-3">
            <img class="me-2" src="{{ asset('image/logo2.png') }}" alt="" height="40" />
        </div>
      </a>
    </div>
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
      <div class="navbar-vertical-content scrollbar">
        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
          <li class="nav-item">
            <a class="nav-link {{  request()->routeIs('dashboard') ? 'active' : '' }}" href="/" role="button" aria-expanded="false">
                <div class="d-flex align-items-center">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link {{  request()->routeIs('purchase.list') ? 'active' : '' }}" href="{{ route('purchase.list') }}" role="button" aria-expanded="false">
              <div class="d-flex align-items-center">
                ...
                <span class="nav-link-text ps-1">Purchase Request</span>
